## MSD g2 calculation for unscaled positions 

### First define a function to do the calculation for one temeprature. 
MSD_unscaled_g2_one_temp_Tmean=function(path="~/Dropbox/lammps/PMMA_big/atom300",filename="atom.300_1.txt"
  ...
  timeRecordB()
  atom.300.1_fread[,mass:=decode(x = type, search = atom_type, replace = atom_type_mass)]
...
# MSD_unscaled_g2_one_temp_Tmean(path="~/Dropbox/lammps/PMMA_big/atom300",filename="atom.300_1.txt"
#                                ,molecule_atoms=602,num_mol=64,atom_type=1:10
#                                ,atom_type_mass=c(1.0079,12.011,12.011,12.011,15.9999,15.9999,12.011,12.011,1.0079,12.011),core_num=4)
...
MSD_unscaled_g2_Tmean=function(Path="~/Dropbox/lammps/",polymer="PMMA_big",temperatures=seq(300,600,by=20)
                             ,molecule_atoms=602,num_mol=64,atom_type=1:10
  ...
  for (i in seq_along(temperatures)){
    ...
    # calculation for MSD
    MSD_unscaled_g2_one_temp_Tmean(path=path,filename =filename
