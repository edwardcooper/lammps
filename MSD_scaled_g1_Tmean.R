## MSD g1 calculation for scaled positions a.k.a using xs,ys,zs,ix,iy,iz. 

### First define a function to do the calculation for one temeprature. 
MSD_scaled_g1_one_temp_Tmean=function(path="~/Dropbox/lammps/PS_20/atom300",filename="atom.300_1"
                                      ,molecule_atoms=645,num_mol=40,molecule_monomers=40
                                      ,monomer_atoms=16,atom_type=1:6,atom_type_mass=c(12.011,1.0079,12.011,12.011,12.011,1.0079),polymer="PS_20",core_num=4){
...
# MSD_scaled_g1_one_temp_Tmean(path="~/Dropbox/lammps/PS_20/atom300",filename="atom.300_1"
#                              ,molecule_atoms=645,num_mol=40,molecule_monomers=40
...
MSD_scaled_g1_Tmean=function(Path="~/Dropbox/lammps/",polymer="PS_20",temperatures=seq(200,520,by=20)
                             ,molecule_atoms=645,num_mol=40,molecule_monomers=40
                             ,monomer_atoms=16,atom_type=1:6,atom_type_mass=c(12.011,1.0079,12.011,12.011,12.011,1.0079)
                             ,core_num=4){
  # load the timeRecord functions from my github account.
  ...
  for (i in seq_along(temperatures)){
    ...
    # calculation for MSD
    MSD_scaled_g1_one_temp_Tmean(path=path,filename =filename
