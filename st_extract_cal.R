...
# st_test_result8=log_data4%>%map(function(data) st_extract_tc(data,method="kpss",interval=10^5))
...
# colnames(log_data3)
# st_test_result3=log_data3%>%map(function(data) st_extract_tc(data,method="kpss",interval=10^6))
